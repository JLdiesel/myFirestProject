            ...
            headerLeft: (
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', margin: 5 }}>
                    <TouchableOpacity onPress={() => navigation.goBack()}>
                        <Image source={require('../../images/2.png')} style={{ width: 15, height: 20 }}></Image>
                    </TouchableOpacity>
                </View>
            ),
            headerTitle: (
            ...
            <View style={styles.container}>
                ...
                >
                    ...
                    <View style={[{ flexDirection: 'row' }]}>
                        ...
                        <ImageBackground source={require('../../images/sao.png')} style={{ width: 200, height: 200 }}>
                            <Animated.View style={[
                                styles.border,
                    ...
                    <TouchableOpacity onPress={this.context.goBack}>
                        <View style={{ marginTop: pxToDp(20) }}>
                            <Text style={{ fontSize: pxToDp(26), fontWeight: 'bold' }}> 返回 </Text>
                        </View>
                    </TouchableOpacity>
                </RNCamera>
            </View>
